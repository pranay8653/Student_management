        ...
        <div class="col-md-12 mx-auto">
            <div class="card mb-4 py-3 border-bottom-info">
                <div class="card-body">
                  ...
                  <form action="{{ route('update.notes',['id' =>$notes->id ]) }}" method="POST" name="myForm" class="user">
                    @csrf
                    @method('PUT')
                    <div class="row" >
                        <input type="hidden" class="form-control form-control-user" value="{{ $notes->id }}" name="id" id="FirstName" >
                        <div class="col-md-12 mb-12">
                            ...
                            <label for="aadress"> </label>
                                ...
                                name="studynote_title" >{{ $notes->studynote_title }} </textarea>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-12">
                            ...
                            <label for="aadress"> </label>
                                ...
                                name="studynote" >{{ $notes->studynote }} </textarea>
                        </div>
                    </div>
                    <br>
