<h1 style="font-family: 'Water Brush', cursive;"> Welcome <strong>'{{ $user->first_name }} {{ $user->last_name }}'</strong> </h1>
<p  > You Are Successfully Registered. Login By This Email-id Or This Mobile Number. After Login, You Must Change Your Password !</p>
